...
if(isset($_POST['submit']))
  {
   ...
   $query=mysqli_query($con, "update tblpricelist set TopWear='$topwear',  BottomWear='$bottomwear', Kaftan='$kaftan', Woolen='$woolen' where Id='$eid'");
    if ($query) {
...
?>
        ...
        <div class="form-row">
          <div class="col-md-6">
            <div class="form-label-group">
              <input type="text" id="kaftan" name="kaftan" class="form-control"  required="required" value="<?php  echo $row['Kaftan'];?>">
                <label for="kaftan">Kaftan Price</label>
                 </div>
              </div>
